  ...
  label: { tr: ['\\u5468\\u5929\\u723d'], en: ['\\u5468\\u5929\\u723d'], de: ['\\u5468\\u5929\\u723d'] },
      ...
      subs: [
        {
          ...
          html: {
            tr: `
              <p><strong>项目</strong></p>
              <ul><li>即将更新...</li><li>即将更新...</li><li>即将更新...</li></ul>
              <hr class="divider">
              <p><strong>使用的技术</strong></p>
              <ul><li>Python</li><li>待添加</li><li>待添加</li></ul>
            `,
            en: `
              <p><strong>项目</strong></p>
              <ul><li>即将更新...</li><li>即将更新...</li><li>即将更新...</li></ul>
        ...
        {
          id: 'aiProject',
          label: { tr: ['AI', '项目'], en: ['AI', '项目'], de: ['AI', '项目'] },
          title: { tr: 'AI 项目', en: 'AI 项目', de: 'AI 项目' },
          html: {
            tr: `
              ...
              <ul><li>自然语言处理</li><li>机器学习</li><li>生成式 AI</li></ul>
            `,
            en: `
              <p><strong>知识库和工具</strong></p>
              <ul><li>Obsidian</li><li>Codex, VS Code, Gemini, Claude Code</li></ul>
    ...
    /* BIO: Implementation note for this section. */
    {
      ...
      subs: [
        ...
        {
          id: 'soc',
          label: { tr: ['社交媒体'], en: ['社交媒体'], de: ['社交媒体'] },
          title: { tr: '社交媒体', en: '社交媒体', de: '社交媒体' },
          html: {
            tr: `
            <p>微信：19858493168</p>
            <p>小红书：63011307889</p>`,
...
function applyChineseLanguageSlotDefault() {
  ...
  const zhNodeText = {
    ...
    tec: {
      label: ['\u6280\u672f\u8d8b\u52bf'],
      title: '\u6280\u672f\u8d8b\u52bf',
      html: `<p><strong>\u5173\u6ce8\u9886\u57df</strong></p><ul><li>\u4eba\u5de5\u667a\u80fd\u4e0e\u5927\u8bed\u8a00\u6a21\u578b\u53d1\u5c55</li><li>\u65b0\u80fd\u6e90\u6c7d\u8f66\u6280\u672f</li><li>\u5177\u8eab\u667a\u80fd</li><li>\u81ea\u52a8\u9a7e\u9a76\u4e0e\u8f85\u52a9\u9a7e\u9a76</li></ul><hr class="divider"><p>\u6211\u559c\u6b22\u5173\u6ce8\u6280\u672f\u8d8b\u52bf\u3002\u65b0\u7684\u6280\u672f\u53d8\u5316\u80fd\u5e2e\u52a9\u6211\u6253\u5f00\u601d\u8def\uff0c\u4e5f\u8ba9\u6211\u6301\u7eed\u5b66\u4e60\u3001\u4fdd\u6301\u8fdb\u6b65\u3002</p>`
    },
    trv: {
      label: ['\u65c5\u884c'],
      title: '\u65c5\u884c',
      html: `<p>\u6211\u559c\u6b22\u65c5\u884c\u548c\u63a2\u7d22\u65b0\u7684\u5730\u65b9\u3002\u6bcf\u5230\u4e00\u4e2a\u65b0\u7684\u73af\u5883\uff0c\u90fd\u80fd\u5e26\u6765\u65b0\u7684\u7ecf\u9a8c\u3001\u60f3\u6cd5\u548c\u89c6\u89d2\u3002</p><hr class="divider"><p><em>\u6211\u4eab\u53d7\u5728\u8def\u4e0a\u89c2\u5bdf\u4e16\u754c\uff0c\u4e5f\u628a\u8fd9\u4e9b\u7ecf\u5386\u5e26\u56de\u5b66\u4e60\u548c\u751f\u6d3b\u91cc\u3002</em></p>`
    },
    skills: { label: ['\u6280\u80fd\u4e0e', '\u5174\u8da3'] },
